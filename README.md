...
## Environments
- Preview: https://main--aemcloudb--KathyZhaoDoE.aem.page/
- Live: https://main--aemcloudb--KathyZhaoDoE.aem.live/
...
1. Open the `aemcloudb` directory in your favorite IDE and start coding :)
